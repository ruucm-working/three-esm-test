...
// esbuild-css-modules-plugin-namespace:/tmp/tmp-1773-qvKolvKV3uqv/main/src/Button.modules.css.js
...
var Button_modules_css_default = { "button": "_button_73mgf_1" };
...
// src/Button.tsx
var Box = styled_components_browser_esm_default.span`
  background: red;
`;
function Button({ title = "Title" }) {
  return /* @__PURE__ */ createElement("button", {
    className: Button_modules_css_default.button
  }, title, /* @__PURE__ */ createElement(Box, null, "Box"));
}
export {
  Button
};
